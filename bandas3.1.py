...
def main():
    ...
    k_interp = 100
    kx_points = mp.interpolate(k_interp, [mp.Vector3(), mp.Vector3(0.5, 0)])  # Γ → X
    ky_points = mp.interpolate(k_interp, [mp.Vector3(), mp.Vector3(0, 0.5)])  # Γ → Y
    ...
    ky_values = [-k.y for k in ky_points]  # Valores negativos para distinguir no eixo x
